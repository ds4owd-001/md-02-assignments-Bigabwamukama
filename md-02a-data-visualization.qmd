...
4.  the link is <https://www.perplexity.ai/search/r-label-loaddata-jdZ0GD7JQiGgdST9RyvQiQ?s=c>

5.  Run the code contained in the code chunk and fix any errors.

6.  What are the data types of the three variables used for aesthetic mappings?

7.  the three data types are type factor (continent and fill) and type numeric (lifeExp)
...
-   population to the size argument; this brought and error and is not included
...
4.  What is stored in the `country_colors` object? Find out by executing the object in the Console (type it to the Console and hit enter). it shows a list of various countries and their color codes in the console.
